...
class App extends React.Component {
  ...
  patchNode(id, data) {
    if (
      ...
      this.fetchJsonApiPatch(
        'patch',
        `${JSONAPI_ROOT}node/article/${id}`,
        data
      );
    }
  }
    ...
    return (
      <div>
        ...
        {this.state.confirm === true && (
          <button style={style.inactive}>Delete</button>
        )}
        {this.state.confirm === true && (
          <div style={style.panel}>
            <div>Delete this Node?</div>
            <br />
  ...
  render() {
    ...
    return (
      <form style={styles.form} onSubmit={this.handleSubmit}>
        ...
        <br />
        <input name="submit" type="submit" value="Save" style={styles.button} />
      </form>
    );
  }
}
          ...
          {this.props.attributes.body && (
            <div
              dangerouslySetInnerHTML={{
                __html: this.props.attributes.body.value
              }}
            />
          )}
        </div>
          ...
          {this.state.showEdit === true && (
            <div>
              <NodeEdit
                ...
                body={this.props.attributes.body.value}
                cancelEdit={this.cancelEdit}
              />
              <button onClick={() => this.cancelEdit()}>View</button>
            </div>
          )}
